                ...
                <div className="container">
                    <div className="row listrecent listrelated">
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                <a href="post.html">
                                    <img className="img-fluid img-thumb" src={require('../../../assets/img/demopic/9.jpg')} alt="" />
                                </a>
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                <a href="post.html">
                                    <img className="img-fluid img-thumb" src={require('../../../assets/img/demopic/8.jpg')} alt="" />
                                </a>
                                <div className="card-block">
                        ...
                        <div className="col-md-4">
                            <div className="card">
                                <a href="post.html">
                                    <img className="img-fluid img-thumb" src={require('../../../assets/img/demopic/7.jpg')} alt="" />
                                </a>
                                <div className="card-block">
