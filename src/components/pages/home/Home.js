        ...
        return (
            ...
            <section className="featured-posts">
              ...
              <div className="card-columns listfeaturedtag">
                    {this.props.listUser.map((listItem)=><PostFeature listItem={listItem} key={listItem.id}/>)}
              </div>
            </section>   
            {/* End Featured================================================== */}
            {/* Begin List Posts================================================== */}
            ...
            <section className="recent-posts">
              ...
              <div className="card-columns listrecent">
                ...
                {this.props.listUser.map((listItem)=><PostAllPost listItem={listItem} key={listItem.id}/>)}
